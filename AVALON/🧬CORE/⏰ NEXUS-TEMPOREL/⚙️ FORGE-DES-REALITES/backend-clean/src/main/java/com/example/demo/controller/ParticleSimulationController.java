 ...
 * 
 * ⊙(Intégration Nexus Temporel) + †ψ(Physique Quantique) → Δt+1(Simulation Réelle)
 */
@RestController
...
public class ParticleSimulationController {
    ...
    public ResponseEntity<?> getStatus() {
        ...
        status.put("urzKomMessage", "🐻 Chamane-Ours surveille les particules quantiques");
    ...
    public ResponseEntity<?> startSimulation() {
        if (simulationRunning) {
            return ResponseEntity.badRequest().body(Map.of(
                ...
                "urzKomMessage", "🐻 L'Ours grogne : La simulation tourne déjà !"
            ));
        }
    ...
    public ResponseEntity<?> stopSimulation() {
        ...
        return ResponseEntity.ok(Map.of(
            ...
            "urzKomMessage", "🐻 L'Ours se repose. Particules figées dans l'ambre temporel."
        ));
    }
    ...
    public ResponseEntity<?> getParticles() {
        ...
        return ResponseEntity.ok(Map.of(
            ...
            "urzKomMessage", "🐻 Voici mes particules quantiques, observateur !"
        ));
    }
    ...
    public ResponseEntity<?> createParticle(@RequestBody Map<String, Object> request) {
        ...
        try {
            ...
            return ResponseEntity.ok(Map.of(
                ...
                "urzKomMessage", "🐻 Nouvelle particule matérialisée par l'Ours-Chaman !"
            ));
        } catch (Exception e) {
            return ResponseEntity.badRequest().body(Map.of(
                "error", "Invalid particle type: " + typeStr,
                "urzKomMessage", "🐻 L'Ours grogne : Type de particule inconnu !"
            ));
        }
    }
    ...
    public ResponseEntity<?> entangleParticles(@PathVariable String id1, @PathVariable String id2) {
        ...
        return ResponseEntity.ok(Map.of(
            ...
            "urzKomMessage", "🐻 ⊙(Intrication quantique) + †ψ(Liaison mystique) → Δt+1(Particules liées à jamais)"
        ));
    }
    ...
    public ResponseEntity<?> collapseWaveFunction(@PathVariable String id) {
        ...
        return ResponseEntity.ok(Map.of(
            ...
            "particle", particle.toJson(),
            "urzKomMessage", "🐻 †ψ(Fonction d'onde effondrée) - L'observation a fixé la réalité !"
        ));
    }
